...
use reservoir_datasets::fixed_datasets::{
    FixedI16, FixedI32, NARMA_LEN, NARMA_TARGETS_I16, NARMA_TARGETS_I32,
};
...
extern "C" fn main() -> ! {
    ...
    let steps = core::cmp::min(NARMA_LEN, max_steps);

    let data_i32: &[FixedI32] = &NARMA_TARGETS_I32[..steps];
    let data_i16: &[FixedI16] = &NARMA_TARGETS_I16[..steps];
    ...
    utils::draw_text("NARMA I16F16", 4, 4, Color::RED);
    utils::draw_text("NARMA I32F32", 4, half_h + 4, Color::GREEN);
