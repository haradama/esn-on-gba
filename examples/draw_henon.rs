...
use reservoir_datasets::fixed_datasets::{FixedI16, FixedI32, HENON_I16, HENON_I32, HENON_LEN};
...
extern "C" fn main() -> ! {
    ...
    let steps = core::cmp::min(HENON_LEN, max_steps);

    let data_i32: &[FixedI32] = &HENON_I32[..steps];
    let data_i16: &[FixedI16] = &HENON_I16[..steps];
    ...
    utils::draw_text("HENON I16F16", 4, 4, Color::RED);
    utils::draw_text("HENON I32F32", 4, half_h + 4, Color::GREEN);
